...
export default{
    data(){
        return {
            FGO: FGO,
            CGO: [
            {name: 'John Doe1', grade: 'Capt', rank: '', joinSpouse: false, EFMP: false, issueRNLTD: false, vector1: '', vector2: '', vector3: '', vector4: '', comment: '', qualifications: []},
            {name: 'John Doe2', grade: 'Capt', rank: '', joinSpouse: false, EFMP: false, issueRNLTD: false, vector1: '', vector2: '', vector3: '', vector4: '', comment: '', qualifications: []},
            {name: 'John Doe3', grade: 'Capt', rank: '', joinSpouse: false, EFMP: false, issueRNLTD: false, vector1: '', vector2: '', vector3: '', vector4: '', comment: '', qualifications: []},
            {name: 'John Doe3', grade: 'Capt', rank: '', joinSpouse: false, EFMP: false, issueRNLTD: false, vector1: '', vector2: '', vector3: '', vector4: '', comment: '', qualifications: []},
            ],
            vectorList:[
              'None',
